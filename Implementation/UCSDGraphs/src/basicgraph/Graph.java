...
public abstract class Graph {
	...
	/**
	 * Add new vertex to the graph. This vertex will have as its index the next
	 * available integer. Precondition: contiguous integers are used to index
	 * vertices.
	 * 
	 ...
	 * 
	 * @param u
	 *            Index of the start point of the edge to be added.
	 * @param v
	 *            Index of the end point of the edge to be added.
	 */
	...
	public List<Integer> degreeSequence() {
		...
		for (int i = 0; i < vertices; i++) {
			degree.add(getInNeighbors(i).size()+getNeighbors(i).size());
		}
		Collections.sort(degree, Comparator.reverseOrder());
		return degree;
	}
	 ...
	 *         (by following two edges) from vertex v. XXX: Implement in part 2
	 *         of week 1 for each subclass of Graph
	 */
	 ...
	 * 
	 * @param The
	 *            index of the vertex to be labeled.
	 * @param The
	 *            label to be assigned to this vertex.
	 */
